...
__inline ErrorCode         DeviceCtrl_getHwSpecific(DeviceCtrl *obj, wchar_t *name, int32 *size, void *buffer)                            { return DAQFN_ETTT(DNLAPI_BASE, 103, wchar_t *, int32 *, void*)(obj, name, size, buffer); }   
__inline ErrorCode         DeviceCtrl_setHwSpecific(DeviceCtrl *obj, wchar_t *name, int32 size, void *buffer)                             { return DAQFN_ETTT(DNLAPI_BASE, 104, wchar_t *, int32,   void*)(obj, name, size, buffer); }   
...
__inline void              CntrFeatures_getUdValueResetTimes(CntrFeatures *obj, MathInterval *x)                                         {        DAQFN_VT(DNLAPI_CNTR, 192, MathInterval *)(obj, x); }
...
/*EsChannel                                                  */
/* ----------------------------------------------------------*/
__inline int32             EsChannel_getChannel(EsChannel *obj)                                                                              { return DAQFN_TV(DNLAPI_CNTR, 192, int32)(obj);              }
__inline int8              EsChannel_getNoiseFiltered(EsChannel *obj)                                                                        { return DAQFN_TV(DNLAPI_CNTR, 193, int8)(obj);               }
__inline ErrorCode         EsChannel_setNoiseFiltered(EsChannel *obj, int8 value)                                                            { return DAQFN_ET(DNLAPI_CNTR, 194, int8)(obj, value);        }
__inline ActiveSignal      EsChannel_getStartCountingEdge(EsChannel *obj)                                                                    { return DAQFN_TV(DNLAPI_CNTR, 195, ActiveSignal)(obj);       }
__inline ErrorCode         EsChannel_setStartCountingEdge(EsChannel *obj, ActiveSignal value)                                                { return DAQFN_ET(DNLAPI_CNTR, 196, ActiveSignal)(obj, value);}
__inline ActiveSignal      EsChannel_getStopCountingEdge(EsChannel *obj)                                                                     { return DAQFN_TV(DNLAPI_CNTR, 197, ActiveSignal)(obj);       }
__inline ErrorCode         EsChannel_setStopCountingEdge(EsChannel *obj, ActiveSignal value)                                                 { return DAQFN_ET(DNLAPI_CNTR, 198, ActiveSignal)(obj, value);}

/* ----------------------------------------------------------*/                                        
/*EdgeSeparationCtrl                                         */
/* ----------------------------------------------------------*/   
/*base1*/
__inline ErrorCode              EdgeSeparationCtrl_LoadProfile(EdgeSeparationCtrl *obj, wchar_t const *fileName)                                   { return DAQFN_ET(DNLAPI_BASE, 98, wchar_t const *)(obj, fileName);   }  
__inline void                   EdgeSeparationCtrl_Cleanup(EdgeSeparationCtrl *obj)                                                                {        DAQFN_VV(DNLAPI_BASE, 83)(obj);                              }
__inline void                   EdgeSeparationCtrl_Dispose(EdgeSeparationCtrl *obj)                                                                {        DAQFN_VV(DNLAPI_BASE, 84)(obj);                              }
__inline void                   EdgeSeparationCtrl_getSelectedDevice(EdgeSeparationCtrl *obj, DeviceInformation *x)                                {        DAQFN_VT(DNLAPI_BASE, 85, DeviceInformation*)(obj, x);       }
__inline ErrorCode              EdgeSeparationCtrl_setSelectedDevice(EdgeSeparationCtrl *obj, DeviceInformation const *x)                          { return DAQFN_ET(DNLAPI_BASE, 86, DeviceInformation const*)(obj, x); }
__inline ControlState           EdgeSeparationCtrl_getState(void *obj)                                                                             { return DAQFN_TV(DNLAPI_BASE, 87, ControlState)(obj);   }
__inline DeviceCtrl *           EdgeSeparationCtrl_getDevice(EdgeSeparationCtrl *obj)                                                              { return DAQFN_TV(DNLAPI_BASE, 88, DeviceCtrl *)(obj);   }
__inline IArray *               EdgeSeparationCtrl_getSupportedDevices(EdgeSeparationCtrl *obj)                                                    { return DAQFN_TV(DNLAPI_BASE, 89, IArray *)(obj);       }
__inline IArray *               EdgeSeparationCtrl_getSupportedModes(EdgeSeparationCtrl *obj)                                                      { return DAQFN_TV(DNLAPI_BASE, 90, IArray *)(obj);       }
/*base2*/                                                                                                        
__inline CntrFeatures *         EdgeSeparationCtrl_getFeatures(EdgeSeparationCtrl *obj)                                                            { return DAQFN_TV(DNLAPI_CNTR, 34, CntrFeatures *)(obj); }
__inline int32                  EdgeSeparationCtrl_getChannelStart(EdgeSeparationCtrl *obj)                                                        { return DAQFN_TV(DNLAPI_CNTR, 35, int32)(obj);          }
__inline ErrorCode              EdgeSeparationCtrl_setChannelStart(EdgeSeparationCtrl *obj, int32 value)                                           { return DAQFN_ET(DNLAPI_CNTR, 36, int32)(obj, value);   }
__inline int32                  EdgeSeparationCtrl_getChannelCount(EdgeSeparationCtrl *obj)                                                        { return DAQFN_TV(DNLAPI_CNTR, 37, int32)(obj);          }
__inline ErrorCode              EdgeSeparationCtrl_setChannelCount(EdgeSeparationCtrl *obj, int32 value)                                           { return DAQFN_ET(DNLAPI_CNTR, 38, int32)(obj, value);   }
__inline int8                   EdgeSeparationCtrl_getEnabled(EdgeSeparationCtrl *obj)                                                             { return DAQFN_TV(DNLAPI_CNTR, 39, int8)(obj);           }
__inline ErrorCode              EdgeSeparationCtrl_setEnabled(EdgeSeparationCtrl *obj, int8 enabled)                                               { return DAQFN_ET(DNLAPI_CNTR, 40, int8)(obj, enabled);  }
__inline int8                   EdgeSeparationCtrl_getRunning(EdgeSeparationCtrl *obj)                                                             { return DAQFN_TV(DNLAPI_CNTR, 41, int8)(obj);           }
__inline double                 EdgeSeparationCtrl_getNoiseFilterBlockTime(EdgeSeparationCtrl *obj)                                                { return DAQFN_TV(DNLAPI_CNTR, 42, double)(obj);         }
__inline ErrorCode              EdgeSeparationCtrl_setNoiseFilterBlockTime(EdgeSeparationCtrl *obj, double value)                                  { return DAQFN_ET(DNLAPI_CNTR, 43, double)(obj, value);  }
__inline NosFltChannel *        EdgeSeparationCtrl_getNoiseFilter_getNoiseFilter(EdgeSeparationCtrl *obj)                                          { return DAQFN_TV(DNLAPI_CNTR, 44, NosFltChannel *)(obj);}
/* Edge Separation methods */                                                                                    
__inline ErrorCode              EdgeSeparationCtrl_Read(EdgeSeparationCtrl *obj, int32 count, double *buffer)                                      { return DAQFN_ETT(DNLAPI_CNTR, 199, int32, double *)(obj, count, buffer); }
__inline IArray *               EdgeSeparationCtrl_getChannels(EdgeSeparationCtrl *obj)                                                            { return DAQFN_TV(DNLAPI_CNTR, 200, IArray *)(obj);                        }
/*creator*/
__inline EdgeSeparationCtrl*    EdgeSeparationCtrl_Create(void)                                                                                    { return (EdgeSeparationCtrl *)DaqCtrlBase_Create(SceEdgeSeparation);     } 
