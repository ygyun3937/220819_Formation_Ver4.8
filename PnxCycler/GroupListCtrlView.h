...
#define WM_GROUP_VIEW_SELECT				( WM_USER + 200 )
#define WM_GROUP_VIEW_RCLICK				( WM_USER + 201 )
#define WM_GROUP_VIEW_COLUMN_OVER			( WM_USER + 202 )
#define WM_GROUP_VIEW_COLUMN_LEAVE			( WM_USER + 203 )
#define WM_GROUP_VIEW_COLUMN_LCLICK			( WM_USER + 204 )
#define WM_GROUP_VIEW_DBCLICK				( WM_USER + 205 )
#define WM_GROUP_VIEW_CLEAR					( WM_USER + 206 )
#define WM_GROUP_VIEW_EDIT_CHANGE			( WM_USER + 207)


class CGroupListCtrlView : public CWnd
{
	DECLARE_DYNAMIC(CGroupListCtrlView)

public:
	CGroupListCtrlView();
	virtual ~CGroupListCtrlView();
