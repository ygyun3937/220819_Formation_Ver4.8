...
CStandardModbus::CStandardModbus()
{
}
...
bool CStandardModbus::Initialize()
{
	InitializeVariables();
...
bool CStandardModbus::InitializeVariables()
{
	return true;
}
...
int CStandardModbus::OpenModbus(CString strIpAddRess, int nPort, int nSlaveId)
{
...
int CStandardModbus::CloseModBus()
{
	return 0;
}

int CStandardModbus::ConnectServer()
{
	bool resultValue = m_Modbus->modbus_connect();		//connect with the server
...
int CStandardModbus::DisconnectServer()
{
 ...
 * \return 
 */
int CStandardModbus::ReadCoil(uint16_t address, uint16_t amount, bool *buffer)
{
	//bool read_coil;
 ...
 * \return 
 */
int CStandardModbus::ReadInputBits(uint16_t address, uint16_t amount, bool *buffer)
{
	//bool read_bits;
 ...
 * \return 
 */
int CStandardModbus::ReadHoldingRegisters(uint16_t address, uint16_t amount, uint16_t *buffer)
{
 ...
 * \return 
 */
int CStandardModbus::ReadInputRegisters(uint16_t address, uint16_t amount, uint16_t *buffer)
{
 ...
 * \return 
 */
int CStandardModbus::WriteSingleCoil(uint16_t address, const bool &to_write)
{
 ...
 * \return 
 */
int CStandardModbus::WriteSingleRegister(uint16_t address, const uint16_t &value)
{
 ...
 * \return 
 */
int CStandardModbus::WriteMultipleCoils(uint16_t address, uint16_t amount, const bool *value)
{
 ...
 * \return 
 */
int CStandardModbus::WriteMultipleRegisters(uint16_t address, uint16_t amount, const uint16_t *value)
{
