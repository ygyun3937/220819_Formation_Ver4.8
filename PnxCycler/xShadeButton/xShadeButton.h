...
#include "afxcmn.h"
	...
	public:
		...
		void SetIcon(UINT nIcon, UINT nIconAlign=BS_CENTER, int nXMargin=0, UINT nIconDown=0, UINT nIconHighLight=0);
	...
	protected:
		...
		// 2011.06.17 Add Start J.C
	private:
		BOOL		m_bPLCType;
		UINT		m_nShadeID;
		//	BOOL		m_bLamp;
		COLORREF	m_LampColor;

	public:
		void SetPLCType(int nPLCType = TRUE) {m_bPLCType = nPLCType;}			// PLC 버튼으로 사용하려면 이놈을 호출해준다.
		//void SetManualPLCType();
		void SetButtonLampSet(COLORREF color=RGB(0,0,0));
		DWORD m_dwPress;
		DWORD	m_dwtUp;
		BOOL		m_bPLCButton;
	};
