...
typedef enum _LCM10COMMAND
{
	...
	Lcm10Ch1MaxVelWrite						= 0x8C,				// CH1 MAX VEL WRITE (only use 5000 Base)
	Lcm10Ch1MaxVelUnitDataWrite				= 0x8D,				// CH1 MAX VEL UnitDataWrite (only use 5000 Base)
	Lcm10Ch1MaxVelRead						= 0x04,				// CH1 MAX VEL READ (only use 5000 Base)
