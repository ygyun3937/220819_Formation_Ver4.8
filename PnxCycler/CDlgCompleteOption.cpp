...
void CDlgCompleteOption::OnBnClickedBtnImmediatelyComplete()
{
	...
	//if (false == pMgr->IsCyclerChannelSelected(GetStageNo()))
	//{
	...
	//pMgr->SetCyclerChannelPauseOption(eCyclerCommandOptionCompleteImmediately, GetStageNo());
	SetImmediatelyComplete(GetStageNo());
...
void CDlgCompleteOption::OnBnClickedBtnStepcompleteComplete()
{
	...
	if (false == pMgr->IsCyclerChannelStarted(GetStageNo()))
	{
	...
	pMgr->SetCyclerChannelPauseOption(eCyclerCommandOptionCompleteAfterStepComplete, GetStageNo());
...
void CDlgCompleteOption::OnBnClickedBtnCyclecompleteComplete()
{
	...
	pMgr->SetCyclerChannelPauseOption(eCyclerCommandOptionCompleteAfterCycleComplete, GetStageNo());
...
void CDlgCompleteOption::SetImmediatelyComplete(int nStageNo)
{
	CMgrChannel* pMgr = CMgrChannel::GetMgr();
	if (!pMgr)
		return;
	...
	CMgrStatus::GetMgr()->SetEqInitFlag(GetStageNo(), FALSE);
