...
//
#ifdef __cplusplus
	#define MXIOEXPORT extern "C" __declspec(dllimport)
#else
...
#define PGM_SERIES							32
#define E1500_SERIES						64
#define ioPAC8000_SERIES					128
#define AOPC_SERVER 						256
#define RTU_SERIES							512
//---------------------------------------------------------------------------
